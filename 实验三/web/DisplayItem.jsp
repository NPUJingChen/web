...
<%
	String[] choices = {"Item1: The light beer of China","Item2: The amber beer of China","Item3: The beer of American"};
	pageContext.setAttribute("choices", choices);
%>
 <table width="500" border="0" cellspacing="0" cellpadding="0">
   <c:forEach var = "choice" items = "${pageScope.choices}">
    <tr>
     <td width="69">
     	<input type="checkbox" name = "item" value = "${choice}">
     </td>
     <td width="431">${choice}</td>
    </tr>
   </c:forEach>
 </table>
  <hr>
